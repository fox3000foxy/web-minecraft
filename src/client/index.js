...
var brownish, dat, dirtID, grassID, greenish, h, mesh, movePlayer, noa, player, scene, socket, textureURL, w, world;
...
movePlayer = function(x, y, z) {
  return noa.entities.setPosition(player, [x, y, z]);
};
...
setInterval(function() {
  ...
  camB._impulses[1] = 0;
  camB._impulses[2] = 0;
  return camB.gravityMultiplier = 0;
});
