...
var Chunk, brownish, dat, dirtID, getVoxelID, grassID, greenish, h, mesh, noa, player, scene, socket, textureURL, w;
...
socket.on("connect", function() {
  ...
  socket.on("mapChunk", function(json) {
    var ch;
    ch = Chunk.fromJson(json);
    return console.log(ch.sections);
  });
